...
.L00 ;  rem ** Fallout Explore

.L01 ;  rem ** by Noah J Stewart
...
.L012 ;  dim direction = b

.L013 ;  dim exploring = 0

.L014 ;  dim itemCount = 0

.L015 ;  dim foundItem = 0

.L016 ;  dim soundPlaying = 0

.
 ; 

.L017 ;  const minPlayer0y  =  40

.L018 ;  const maxPlayer0y  =  70

.L019 ;  const minBallX  =  20

.L020 ;  const maxBallX  =  120

.L021 ;  const minBallY  =  40

.L022 ;  const maxBallY  =  80

.L023 ;  dim ballCounter  =  0

.L024 ;  dim playerAnimation  =  0
...
.L026 ;  score = 0
	...
	LDA #$00
	STA score
.L027 ;  ballx = minBallX : bally = 40 : ballheight = 4
...
PF_data0
	...
	.byte %00111001, %01110011
	if (pfwidth>2)
	.byte %00000011, %01111111
 endif
	.byte %01111111, %11111111
	if (pfwidth>2)
	.byte %11111111, %01110110
 endif
...
.L033 ;  rem ** position the other objects, to prove we still can

.L034 ;  rem player1x=-30:player1y=40

.L035 ;  rem missile1x=100:missile1y=40:missile1height=6
...
.L036 ;  if joy0up  &&  player0y  >  minPlayer0y then gosub movePlayerUp
...
.skip0then
.skipL036
.L037 ;  if joy0down  &&  player0y  <  maxPlayer0y then gosub movePlayerDown
...
.skip2then
.skipL037
.L038 ;  rem if joy0down then player0y = player0y + 1

.
 ; 

.L039 ;  if collision(ball,player0) then gosub hitBall
...
.skipL039
.L040 ;  rem if collision(playfield, player0) then ballx = 0

.
 ; 

.L041 ;  rem if playerAnimation = 1 then animatePlayer2:playerAnimation = 0 else animatePlayer1

.
 ; 

.L042 ;  if ballx  >  maxBallX then ballx  =  minBallX else ballx  =  ballx  +  1
...
.skipL042
	INC ballx
.skipelse0
.L043 ;  if bally  <  minBallY  ||  bally  >  maxBallY then gosub positionBall
...
.L044 ;  rem if frame > 100 then gosub animatePlayer1 else gosub animatePlayer2
...
.L045 ;  frame  =  frame  +  1
	...
	INC frame
.L046 ;  if frame  =  30 then gosub animatePlayer2
...
.skipL046
.L047 ;  if frame  =  60 then gosub animatePlayer1 : frame = 1
...
.L048 ;  rem if rand < 10 then activateMonster

.
 ; 

.L049 ;  if soundPlaying  >  1  &&   ( soundPlaying  +  5 )   <  frame then AUDV0 = 0
...
.L059 ;  ballx  =  minBallX
	...
	LDA #minBallX
	STA ballx
.L060 ;  itemCount  =  itemCount  +  1

	INC itemCount
.L061 ;  soundPlaying = frame
...
.L066 ;  dim randPosition  =  rand

.L067 ;  if randPosition  <   ( maxBallY  -  minBallY )  then bally  =  randPosition  +  minBallY :  foundItem  =  1
...
.L069 ;  player1x = minBallX : player1y = player0y
